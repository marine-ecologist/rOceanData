...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      tags$p(HTML(paste("Select the", fa("square", prefer_type="solid"), "on the map toolbar to set the boundaries of
                   ocean to extract data from, and use the", fa("pencil"), "to edit the area boundaries"))),

...
# to implement:
# deployApp("/Users/rof011/rOceanData/apps/ocean_data_viewer/", appPrimaryDoc="ocean_data_viewer_0.9004.R", appName="oceandata", appTitle="oceandata")
...
ui <- fluidPage(
  tags$head(
    tags$style(HTML("
      ...
      #map {
        height: 1250px; /* Adjust height as needed */
      }
      .main-title {
        text-align: center;
      }
